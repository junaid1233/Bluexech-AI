    ...
    <section id="about" className="section" aria-labelledby="stats-heading">
      <div className="container">
        <div className="section-head center">
          ...
          <p>
            Bluexech AI helps organizations modernize with practical AI, reliable software, and secure
            infrastructure — delivered by specialists who stay close to your goals.
          </p>
        </div>
